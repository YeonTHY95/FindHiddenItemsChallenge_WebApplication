...
export default function ImageSliderComponent({ imagesInfo, n }) {
    ...
    return (React.createElement("div", { ref: imageSliderRef, style: { position: 'relative', display: 'flex' } },
        React.createElement("button", { id: 'previousButton', onClick: previousClick, style: { position: 'absolute', top: '45%', left: 2, padding: 0, fontWeight: 'bold', width: 60, height: 60, textAlign: 'center', backgroundColor: '#FFFDD0', borderColor: 'black' } }, "<"),
        React.createElement("button", { id: 'nextButton', onClick: nextClick, style: { position: 'absolute', top: '45%', right: 2, padding: 0, fontWeight: 'bold', width: 60, height: 60, backgroundColor: '#FFFDD0', borderColor: 'black' } }, ">"),
        imagesInfo.map(image => {
            return (React.createElement("div", { key: image.imageID, style: { width: '90%', height: 'max-content', padding: 10, display: 'none', margin: 'auto' } },
                React.createElement("p", { style: { fontSize: 50, color: 'red', margin: 0 } }, image["imageName"]),
                React.createElement(Link, { to: `/images/${image["imageName"]}` },
                    React.createElement("img", { src: image.imageURL, style: { width: 200, 'height': 300, padding: 2 }, alt: image["imageName"] }))));
        })));
}
